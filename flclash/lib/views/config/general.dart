...
class PortItem extends ConsumerWidget {
  ...
  Future<void> handleShowPortDialog(BuildContext context) async {
    await globalState.showCommonDialog(context: context, child: _PortDialog());

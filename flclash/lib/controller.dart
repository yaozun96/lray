      ...
      builder: (context) => Dialog(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                '${appLocalizations.discoverNewVersion} $tagName',
              ...
              if (body != null && body.isNotEmpty) ...[
                Text(
                  '${appLocalizations.content}:', // Or "Update Content:"
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF2B60D0), // Hardcoded primary blue or use AppTheme if available
                    ...
                    child: const Text('立即更新', style: TextStyle(fontWeight: FontWeight.bold)), // "Update Now"
                  ),
                ],
              ),
            ],
